...
function container_mounts() {
    ...
    echo "/home/padl22t4/pretrained_models/dino":"/pretrained_models"
    echo "/home/padl22t4/osr_novel_categories":"/osr_novel_categories"
    #echo "/home/padl22t4/datasets/":"/datasets"
    echo "${MOUNT}":"/ssd1"
