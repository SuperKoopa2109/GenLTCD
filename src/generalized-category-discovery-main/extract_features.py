...
if __name__ == "__main__":
    ...
    parser.add_argument('--dataset', type=str, default='cifar100', help='options: cifar10, cifar100, scars')
    ...
    if args.dataset == 'cifar10':
        ...
        train_dataset = CustomCIFAR100(root=cifar_100_root, train=True, transform=val_transform, download=True)
        test_dataset = CustomCIFAR100(root=cifar_100_root, train=False, transform=val_transform, download=True)
        targets = list(set(train_dataset.targets))
