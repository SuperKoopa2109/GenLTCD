...
def train(projection_head, model, train_loader, test_loader, unlabelled_train_loader, args):
    wandb.init(project="ltgcd", entity="padl22t4")
    ...
    for epoch in range(args.epochs):
        ...
        for batch_idx, batch in enumerate(tqdm(train_loader)):
            ...
            print(f""""internal batch step:{batch_idx} \n epoch: {epoch}""")
        ...
        wandb.log({
            ...
            "Train/Accuracy on Labelled Data":train_acc_record.avg,
            "Train/LR":get_mean_lr(optimizer),
            "Train/Accuracies All":all_acc,
            "Trian Accuracies Old":old_acc,
            "Train/Accuracies New":new_acc,
            "Test/Accuracies All":all_acc_test,
            "Test/Accuracies Old":old_acc_test,
            "Test/Accuracies New":new_acc_test,
            })
...
if __name__ == "__main__":
    ...
    print('430: between train_transform')
    ...
    print('441: after get_train_dataset')
